...
const updateCardTransforms = () => {
  ...
  cardsRef.value.forEach((card, i) => {
    ...
    const triggerStart =
      cardTop - stackPositionPx - props.itemStackDistance * i;
    ...
    const rotation = props.rotationAmount
      ? i * props.rotationAmount * scaleProgress
      : 0;
    ...
    if (props.blurAmount) {
      ...
      for (let j = 0; j < cardsRef.value.length; j++) {
        ...
        const jTriggerStart =
          jCardTop - stackPositionPx - props.itemStackDistance * j;
    ...
    if (isPinned) {
      translateY =
        scrollTop - cardTop + stackPositionPx + props.itemStackDistance * i;
    } else if (scrollTop > pinEnd) {
      translateY =
        pinEnd - cardTop + stackPositionPx + props.itemStackDistance * i;
    }
